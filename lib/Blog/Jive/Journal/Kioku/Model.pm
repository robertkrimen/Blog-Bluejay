package Blog::Jive::Journal::Kioku::Model;
...
package Blog::Jive::Journal::Kioku::Model::Post;
...
sub _build_body {
    my $self = shift;
    return Blog::Jive::Journal::Kioku::Model::Post::Body->new( post => $self );
}

package Blog::Jive::Journal::Kioku::Model::Post::Body;
